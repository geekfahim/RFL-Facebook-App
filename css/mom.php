<?php
	...
	$loginUrl = $helper->getLoginUrl('https://rflplastics.info/mom.php', $permissions);
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="col-sm-6 col-sm-offset-3">
								<div class="box">
									<!--<img src="img/mom.png" alt="" /> <!-- Here is your logo -->
									<br>
									<?php
										if((!$picture['url'])) echo'<img src="img/mom.jpg" alt=""  width="325px"/> <br>';
									?>
									<?php if(!$picture['url']){
										...
										//echo $picture['url'];
										$watermark = imagecreatefrompng('mom.png');
...
<?php
	...
	if (isset($accessToken)) {
		...
		try {
			...
			$data = ['source' => $fb->fileToUpload(__DIR__.'/mom.png'), 'message' => 'my photo'];

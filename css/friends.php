<?php
	...
	$fb = new Facebook\Facebook([
		'app_id' => '1182535585133314',
		'app_secret' => '5350d0342123e9760fd53d8b6188f6ad',
	...
	$loginUrl = $helper->getLoginUrl('https://rflplastics.info/friends.php', $permissions);
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="col-sm-6 col-sm-offset-3">
								<div class="box">
									<!--<img src="img/friends.png" alt="" /> <!-- Here is your logo -->
									<br>
									<?php
										if((!$picture['url'])) echo'<img src="img/friends.jpg" alt=""  width="325px"/> <br>';
									?>
									<?php if(!$picture['url']){
										...
										//echo $picture['url'];
										$watermark = imagecreatefrompng('friends.png');
...
<?php
	...
	if (isset($accessToken)) {
		...
		try {
			...
			$data = ['source' => $fb->fileToUpload(__DIR__.'/friends.png'), 'message' => 'my photo'];
